...
# Sparkle update feed — hosted as a GitHub Release asset on your repo
SPARKLE_FEED_URL="${SPARKLE_FEED_URL:-https://github.com/samattias/TM/releases/latest/download/appcast.xml}"
...
<dict>
    ...
    <string>TaskMiner captures periodic screenshots to understand what you're working on. Screenshots are stored locally and never uploaded.</string>
